...
export default function TeacherSemiconductorCalculator() {
  ...
  const calculateAttendance = (attBySem: Record<string, { absent: number; lateEtc: number }>) => {
...
A`;
    ...
    const sampleData = [
      ...
      ["00000-00002", "김철수", "특별전형", "졸업생", multilineSubjectDataWithFree, multilineGradeDataWithFree, "2020년-15시간", "2021년-12시간", "2022년-10시간", "1", "0", "2", "1", "2", "0", "4", "3", "1"],
