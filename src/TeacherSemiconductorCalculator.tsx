...
export default function TeacherSemiconductorCalculator() {
  ...
  const calculateScore = (student: StudentData) => {
    ...
    if (atype === "검정고시") {
      if (gedSubjects.length === 0) return { courseScore: 0, attScore: 0, volScore: 0, bonusLeadership: 0, bonusCareer: 0, bonusAwards: 0, totalScore: 0 };
  ...
  const handleFileUpload = async (file: File) => {
    ...
    try {
      ...
      for (const [studentName, rows] of Object.entries(studentGroups)) {
        ...
        const atypeRaw = (firstRow[atypeIdx] || "재학생").toString();
        let atype: ApplicantType = "재학생";
  ...
  const downloadResults = async () => {
    ...
    resultData.forEach(student => {
      worksheet.addRow([
        ...
        student.volScore.toFixed(3),
        student.bonusLeadership.toFixed(3),
        student.bonusCareer.toFixed(3),
        student.bonusAwards.toFixed(3),
  ...
  const downloadSample = async () => {
    ...
    // 샘플 데이터 (반도체마이스터고는 모든 항목 포함)
    const sampleData = [
      ["00000-00001", "홍길동", "일반전형", "재학생", "1학년1학기|국어", "A", "2021년-10시간", "2022년-8시간", "2023년-12시간", "2", "1", "0", "2", "3", "1", "3", "2", "1"],
      ["", "", "", "", "1학년1학기|영어", "B", "", "", "", "", "", "", "", "", "", "", "", ""],
      ["", "", "", "", "1학년1학기|수학", "A", "", "", "", "", "", "", "", "", "", "", "", ""],
      ["", "", "", "", "1학년1학기|과학", "A", "", "", "", "", "", "", "", "", "", "", "", ""],
      ["", "", "", "", "1학년2학기|국어", "A", "", "", "", "", "", "", "", "", "", "", "", ""],
      ...
      ["", "", "", "", "3학년1학기|수학", "A", "", "", "", "", "", "", "", "", "", "", "", ""],
      ["", "", "", "", "3학년1학기|과학", "A", "", "", "", "", "", "", "", "", "", "", "", ""],
      ["00000-00002", "김철수", "특별전형", "졸업생", "1학년1학기|국어", "B", "2020년-15시간", "2021년-12시간", "2022년-10시간", "1", "0", "1", "1", "2", "0", "4", "3", "2"],
      ["", "", "", "", "1학년1학기|영어", "B", "", "", "", "", "", "", "", "", "", "", "", ""],
      ["", "", "", "", "1학년1학기|수학", "A", "", "", "", "", "", "", "", "", "", "", "", ""],
      ["", "", "", "", "1학년1학기|과학", "A", "", "", "", "", "", "", "", "", "", "", "", ""],
      ["00000-00003", "이영희", "일반전형", "검정고시", "과목1", "95", "", "", "", "", "", "", "", "", "", "2", "1", "0"],
      ["", "", "", "", "과목2", "88", "", "", "", "", "", "", "", "", "", "", "", ""],
      ["", "", "", "", "과목3", "92", "", "", "", "", "", "", "", "", "", "", "", ""]
    ];
    ...
    const a = document.createElement("a");
    a.href = url;
    a.download = "반도체마이스터고_샘플데이터.xlsx";
    a.click();
    window.URL.revokeObjectURL(url);
  };
              ...
              <tbody>
                {resultData.map((student, index) => (
                  <tr key={index}>
                    ...
                    <td>{student.volScore.toFixed(3)}</td>
                    <td>{student.bonusLeadership.toFixed(3)}</td>
                    <td>{student.bonusCareer.toFixed(3)}</td>
                    <td>{student.bonusAwards.toFixed(3)}</td>
