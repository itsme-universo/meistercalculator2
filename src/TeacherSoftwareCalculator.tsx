...
export default function TeacherSoftwareCalculator() {
  ...
  const downloadResults = async () => {
    ...
    // 헤더 설정
    const headers = [
      "이름", "전형", "지원유형", "교과성적", "출결점수", "봉사점수", "리더십점수", "수상점수", "총점", "유효성"
    ];
  ...
  const downloadSample = async () => {
    ...
    // 샘플 데이터 (소프트웨어마이스터고는 경력 제외)
    const sampleData = [
      ["00000-00001", "홍길동", "일반전형", "재학생", "1학년1학기|국어", "A", "2021년-10시간", "2022년-8시간", "2023년-12시간", "2", "1", "0", "2", "3", "1", "3", "1"],
      ["", "", "", "", "1학년1학기|영어", "B", "", "", "", "", "", "", "", "", "", "", ""],
      ["", "", "", "", "1학년1학기|수학", "A", "", "", "", "", "", "", "", "", "", "", ""],
      ["", "", "", "", "1학년1학기|과학", "A", "", "", "", "", "", "", "", "", "", "", ""],
      ["", "", "", "", "1학년2학기|국어", "A", "", "", "", "", "", "", "", "", "", "", ""],
      ...
      ["", "", "", "", "3학년1학기|수학", "A", "", "", "", "", "", "", "", "", "", "", ""],
      ["", "", "", "", "3학년1학기|과학", "A", "", "", "", "", "", "", "", "", "", "", ""],
      ["00000-00002", "김철수", "특별전형", "졸업생", "1학년1학기|국어", "B", "2020년-15시간", "2021년-12시간", "2022년-10시간", "1", "0", "1", "1", "2", "0", "4", "2"],
      ["", "", "", "", "1학년1학기|영어", "B", "", "", "", "", "", "", "", "", "", "", ""],
      ["", "", "", "", "1학년1학기|수학", "A", "", "", "", "", "", "", "", "", "", "", ""],
      ["", "", "", "", "1학년1학기|과학", "A", "", "", "", "", "", "", "", "", "", "", ""],
      ["00000-00003", "이영희", "일반전형", "검정고시", "과목1", "95", "", "", "", "", "", "", "", "", "", "2", "0"],
      ["", "", "", "", "과목2", "88", "", "", "", "", "", "", "", "", "", "", ""],
      ["", "", "", "", "과목3", "92", "", "", "", "", "", "", "", "", "", "", ""]
    ];
